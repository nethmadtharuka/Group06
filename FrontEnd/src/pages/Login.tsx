...
export const Login = () => {
  ...
  return <div className="min-h-screen bg-[#0a0a0f] w-full flex">
      <div className="hidden lg:block lg:w-1/2 bg-cover bg-center relative" style={{
      backgroundImage: "url('https://uploadthingy.s3.us-west-1.amazonaws.com/1FEVKp5NLe7uhRRXaEWJBx/login.png')"
    }}>
        ...
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="text-gray-400">
              Log in to manage your events and connect with your audience.
            </p>
          </div>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-white mb-2">Email Address or Username</label>
              <input 
                type="text" 
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-purple-600 hover:bg-purple-700 disabled:bg-purple-800 disabled:cursor-not-allowed text-white py-3 px-4 rounded-lg font-medium transition-colors"
            >
