...
const AdminPanel = () => {
  ...
  useEffect(() => {
    try {
      ...
      console.log('AdminPanel - Current user:', user); // Debug log
    ...
    return (
      <div>
        <div className="mb-4 flex justify-between items-center">
          ...
          />
          <p className="text-gray-600">{filteredUsers?.length || 0} users found</p>
        </div>
      ...
      <div>
        <div className="mb-4 flex justify-between items-center">
          <input
            ...
            className="border rounded px-4 py-2 w-64"
          />
          <p className="text-gray-600">{filteredEvents?.length || 0} events found</p>
        </div>
          ...
          {filteredEvents && filteredEvents.length > 0 ? (
            filteredEvents.map(event => (
              <div key={event.id} className="bg-white rounded-lg shadow p-4">
                ...
                <p className="text-gray-600 text-sm mb-2">{event.description || 'No description'}</p>
      ...
      <div>
        <div className="mb-4 flex justify-between items-center">
          <input
            ...
            className="border rounded px-4 py-2 w-64"
          />
          <p className="text-gray-600">{filteredVendors?.length || 0} vendors found</p>
        </div>
              ...
              {filteredVendors && filteredVendors.length > 0 ? (
                filteredVendors.map(vendor => (
                  <tr key={vendor.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">{vendor.businessName || vendor.companyName || '-'}</td>
